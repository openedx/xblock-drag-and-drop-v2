...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Close item feedback popup": "Fechar o pop-up de coment\u00e1rio do item", 
    "Continue": "Continuar", 
    ...
    "Mode": "Modo", 
    "Navigate using TAB and SHIFT+TAB to the appropriate dropzone and press CTRL+M once more to drop it here.": "Navegue usando TAB e SHIFT + TAB para a \u00e1rea apropriada e pressione CTRL + M mais uma vez para solt\u00e1-lo aqui.", 
    ...
    "Press \"Enter\", \"Space\", \"Ctrl-m\", or \"\u2318-m\" on an item to select it for dropping, then navigate to the zone you want to drop it on.": "Pressione \"Enter\", \"Espa\u00e7o\", \"Ctrl-m\" ou \"\u2318-m\" em um item para selecionar e arrast\u00e1-lo, em seguida, v\u00e1 at\u00e9 \u00e0 zona em que voc\u00ea deseja solt\u00e1-lo.", 
    "Press \"Enter\", \"Space\", \"Ctrl-m\", or \"\u2318-m\" to drop the item on the current zone.": "Pressione \"Enter\", \"Space\", \"Ctrl-m\" ou \"\u2318-m\" para soltar o item na zona atual.", 
    "Press \"Esc\" if you want to cancel the drop operation (for example, to select a different item).": "Pressione \"Esc\" caso queira cancelar a a\u00e7\u00e3o de soltar (por exemplo, para selecionar um item diferente).", 
    "Press CTRL+M to select a draggable item (effectively picking it up).": "Pressione CTRL + M para selecionar um item arrast\u00e1vel (pegando-o efetivamente).", 
    "Press ESC if you want to cancel the drop operation (for example, to select a different item).": "Pressione ESC se desejar cancelar a opera\u00e7\u00e3o (por exemplo, para selecionar um item diferente).", 
    "Problem": "Problema", 
    ...
    "Submit": "Enviar", 
    "TAB back to the list of draggable items and repeat this process until all of the draggable items have been placed on their respective dropzones.": "Clique TAB novamente na lista de itens arrast\u00e1veis \u200b\u200be repita esse processo at\u00e9 que todos os itens arrast\u00e1veis \u200b\u200btenham sido colocados em suas respectivas regi\u00f5es.", 
    "Text": "Texto", 
    ...
    "Use \"Tab\" and \"Shift-Tab\" to navigate between items and zones.": "Use as teclas \"Tab\" e \"Shift-Tab\" para navegar entre itens e zonas.", 
    "Use only TAB and SHIFT+TAB to navigate between draggable items and drop zones.": "Use apenas TAB e SHIFT + TAB para navegar entre itens arrast\u00e1veis \u200b\u200be \u00e1reas a serem preenchidas.", 
    ...
    "You can complete this problem using only your keyboard by following the guidance below:": "Voc\u00ea pode concluir esse exerc\u00edcio usando apenas o teclado seguindo as orienta\u00e7\u00f5es abaixo:", 
    "You can complete this problem using only your keyboard.": "Voc\u00ea pode completar este problema usando apenas seu teclado.", 
    "You cannot add any more items to this zone.": "Voc\u00ea n\u00e3o pode adicionar mais itens a esta zona.", 
